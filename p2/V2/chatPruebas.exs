...
# FICHERO: chat.exs
# FECHA: 20/10/17
# TIEMPO: 4 + 3 + 3 + 2 + 3 = 15 horas de trabajo en pareja.
...
#				Ejecutar con "Chat.participante(:nombreRegistro) siendo nombreRegistro el nombre con el que se registrara el proceso que escucha las peticiones y el nomnbre que aparecera en el chat
